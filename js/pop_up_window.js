...
for (var x = 0; x < projectesData.length; x++) {
  ...
  // Card-1 -> child 4/3
  let card_desc_div = document.createElement('div');
  ...
  // adding p tag
  let card_title_p_tag = document.createElement('p');
  card_title_div.appendChild(card_title_p_tag);
  // adding a tag
  let card_title_a_tag = document.createElement('a');
  ...
  // add ul
  let card_desc_ul = document.createElement('ul');
  ...
  let countTechnologies = projectesData[x].technologies.split(",");
  for (var i = 0; i < countTechnologies.length; i++) {
    // add li
    let card_desc_li = document.createElement('li');
    card_desc_ul.appendChild(card_desc_li);
    // adding a
    let card_desc_a = document.createElement('a');
  ...
  // adding p tag
  let card_btn_p_tag = document.createElement('p');
  card_btn_div.appendChild(card_btn_p_tag);
  // adding a tag
  let card_btn_a_tag = document.createElement('button');
